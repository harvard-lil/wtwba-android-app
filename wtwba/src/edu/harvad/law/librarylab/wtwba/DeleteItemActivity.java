...
public class DeleteItemActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String delete_message = "Have you returned " + title
				+ "? If so, delete it.";

		TextView text_title = (TextView) findViewById(R.id.title_preview);

		Spannable string_span = new SpannableString(delete_message);
		string_span.setSpan(new ForegroundColorSpan(Color.rgb(76, 17, 169)),
				18, this.title.length() + 18,
				Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
		string_span.setSpan(new StyleSpan(Typeface.ITALIC), 18,
				this.title.length() + 18, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
